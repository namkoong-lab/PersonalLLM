...
class VanillaICLAlgorithm(BaseAlgorithm):
    """
    ...
    #     prompt = "Below are some examples of the user's past conversation history with two responses per prompt and a chosen one."
    #     history = []
    #     for i in range(int(row["user_history_length"])):
    #         past_prompt = row["prompt_" + str(i + 1)]
    #         past_response_a = row["response_" + str(i + 1) + "_a"]
    #         past_response_b = row["response_" + str(i + 1) + "_b"]
